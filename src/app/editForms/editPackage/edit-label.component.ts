...
export class EditLabelComponent implements OnChanges {
  ...
  ngOnInit() {
    this.route.paramMap
      .switchMap((param: ParamMap) =>
        this.getRecordService.getPackageAndClassification(param.get("id"))
      )
      .subscribe(response => {
  ...
  ngOnChanges() {
    ...
    this.labelForm.reset({
      ...
      package_size_unit_of_measure:
        this.packageData.package_size_unit_of_measure == null
          ? ""
          : this.packageData.package_size_unit_of_measure,
      ...
      multi_part_flag:
        this.packageData.multi_part_flag == null
          ? ""
          : this.packageData.multi_part_flag,
      nutrition_fact_table: this.packageData.nutrition_fact_table,
      as_prepared_per_serving_amount: this.packageData
        .as_prepared_per_serving_amount,
      as_prepared_unit_of_measure:
        this.packageData.as_prepared_unit_of_measure == null
          ? ""
          : this.packageData.as_prepared_unit_of_measure,
      as_sold_per_serving_amount: this.packageData.as_sold_per_serving_amount,
      as_sold_unit_of_measure:
        this.packageData.as_sold_unit_of_measure == null
          ? ""
          : this.packageData.as_sold_unit_of_measure,
      as_prepared_per_serving_amount_in_grams: this.packageData
        .as_prepared_per_serving_amount_in_grams,
      as_sold_per_serving_amount_in_grams: this.packageData
      ...
      informed_dining_program:
        this.packageData.informed_dining_program == null
          ? ""
          : this.packageData.informed_dining_program,
      nft_last_update_date: this.packageData.nft_last_update_date,
      product_grouping: this.packageData.product_grouping,
      child_item:
        this.packageData.child_item == null ? "" : this.packageData.child_item,
      classification_number:
        this.packageData.classification_number == null
          ? ""
          : this.packageData.classification_number,
      classification_name:
        this.packageData.classification_name == null
          ? ""
          : this.packageData.classification_name,
      ...
      calculated:
        this.packageData.calculated == null ? "" : this.packageData.calculated
    });
  }
  ...
  onSubmit() {
    ...
    this.editRecordService
      .UpdateLabel(JSON.stringify(this.packageData))
  ...
  setValues(): void {
    ...
    this.packageData.package_collection_date = this.packageData
      .package_collection_date
      ? date.transform(this.packageData.package_collection_date, "yyyy-MM-dd")
      : this.packageData.package_collection_date;
    this.packageData.nft_last_update_date = this.packageData
      .nft_last_update_date
      ? date.transform(this.packageData.nft_last_update_date, "yyyy-MM-dd")
      : this.packageData.nft_last_update_date;
    ...
    this.packageData.multi_part_flag =
      this.packageData.multi_part_flag == ""
        ? null
        : this.packageData.multi_part_flag;
    this.packageData.as_prepared_per_serving_amount =
      this.packageData.as_prepared_per_serving_amount == ""
        ? null
        : this.packageData.as_prepared_per_serving_amount;
    this.packageData.as_sold_per_serving_amount =
      this.packageData.as_sold_per_serving_amount == ""
        ? null
        : this.packageData.as_sold_per_serving_amount;
    this.packageData.as_prepared_per_serving_amount_in_grams =
      this.packageData.as_prepared_per_serving_amount_in_grams == ""
        ? null
        : this.packageData.as_prepared_per_serving_amount_in_grams;
    this.packageData.as_sold_per_serving_amount_in_grams =
      this.packageData.as_sold_per_serving_amount_in_grams == ""
        ? null
        : this.packageData.as_sold_per_serving_amount_in_grams;
    this.packageData.number_of_units =
      this.packageData.number_of_units == ""
        ? null
        : this.packageData.number_of_units;
    this.packageData.informed_dining_program =
      this.packageData.informed_dining_program == ""
        ? null
        : this.packageData.informed_dining_program;
    this.packageData.product_grouping =
      this.packageData.product_grouping == ""
        ? null
        : this.packageData.product_grouping;
    this.packageData.child_item =
      this.packageData.child_item == "" ? null : this.packageData.child_item;
    this.packageData.calculated =
      this.packageData.calculated == "" ? null : this.packageData.calculated;
    this.packageData.nielsen_item_rank =
      this.packageData.nielsen_item_rank == ""
        ? null
        : this.packageData.nielsen_item_rank;
    this.packageData.package_size =
      this.packageData.package_size == ""
        ? null
        : this.packageData.package_size;
    ...
    this.packageData.classification_number =
      this.packageData.classification_number == ""
        ? null
        : this.packageData.classification_number;
    this.packageData.edited_by = this.username;
  }
